http://www.jcszb.gdtzb.com/v1/1/->wuxiandebugger
...
// const e = {"pageNum":2,"pageSize":20,"releaseTime":"","search":"","informationType":"ANNOUNCEMENT","departmentId":"","projectType":"SZFJ","informationName":"ZBGG"}
// console.log(b);
...
// 网站的 SM2 私钥（你直接贴出来的）
const PRIVATE_KEY = "17d7cf5e57b0ca0d5db32409d222888b3bc0a711ac05707d1e0ea1f31d2ab5b1";

/**
 * 还原网站的 SM2 解密函数
 * @param {string} encryptData - 接口返回的加密字符串（带 04 开头）
 * @returns 解密后的 JSON 对象
 */
function decryptResponse(encryptData) {
    let e = encryptData;

    // 1. 去掉开头的 04（和你网站逻辑完全一样）
    if (e.startsWith("04")) {
        e = e.substring(2);
    }

    // 2. SM2 解密（mode 0 完全一致）
    const t = sm2.doDecrypt(e, PRIVATE_KEY, 0);
...
// ===================== 测试一下 =====================
// 假设你接口返回的加密 data（替换成真实的即可）
const encryptedData = "";

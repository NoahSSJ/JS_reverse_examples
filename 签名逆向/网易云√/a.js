...
location = {
  ...
  href: "https://music.163.com/discover",
  onbeforeurlchange: function() {},
...
const j8b = {
  cq9h: function(gI0x, Va9R, cDK6E) {
    if (!gI0x)
      return "";
    var bw9n = [];
    for (var x in gI0x) {
      bw9n.push(encodeURIComponent(x) + "=" + (!!cDK6E ? encodeURIComponent(gI0x[x]) : gI0x[x]))
    }
    return bw9n.join(Va9R || ",")
  }
};


function get_params(W9N) {
    const AY4c = {
        md: [
    ...
    var i8a = {}
    var mf1x = W9N.indexOf("?");
    
    i8a["csrf_token"] = '2e05908f0cdbbd1b70f214d6731660f2';
    W9N = W9N.replace("api", "weapi");
    
    var bWo2x = asrsea(JSON.stringify(i8a), '010001', '', '0CoJUm6Qyw8W8jud');
...
const W9N = '/api/w/v1/user/detail/6309045118'
get_params(W9N);

// const W9N = '/api/w/v1/user/detail/6309045118'
// // const W9N = '/weapi/v6/playlist/detail'
// get_params(W9N);
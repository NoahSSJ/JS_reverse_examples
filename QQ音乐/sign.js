...
// setProxyArr(['window', 'globalThis', 'navigator', 'location'])
...
// console.log(ie(data))
// console.log("**************************************************")
// ae(data).then(function (data) {
//     console.log(data)
// })



// function get_base64ToArrayBuffer_decode(base64_data) {
//     const binaryString = Buffer.from(base64_data, 'base64').toString('binary');
//     const len = binaryString.length;
//     const bytes = new Uint8Array(len);
//     for (let i = 0; i < len; i++) {
//         bytes[i] = binaryString.charCodeAt(i);
//     }
//     return se(bytes.buffer);
// }


// console.log(get_base64ToArrayBuffer_decode(base64_data))

// a2.js 最后部分这样写（去掉其他顶层 console.log）

// (async () => {
//   const data = '{"comm":{"cv":4747474,"ct":24,"format":"json","inCharset":"utf-8","outCharset":"utf-8","notice":0,"platform":"yqq.json","needNewCode":1,"uin":2570974796,"g_tk_new_20200303":195324016,"g_tk":195324016},"req_1":{"module":"music.musicsearch.HotkeyService","method":"GetHotkeyForQQMusicMobile","param":{"searchid":"31772759347426134","remoteplace":"txt.yqq.top","from":"yqqweb"}},"req_2":{"module":"yqq.WhiteListServer","method":"Pass","param":{}},"req_3":{"module":"yqq.WhiteListServer","method":"Pass","param":{}},"req_4":{"module":"music.paycenterapi.LoginStateVerificationApi","method":"GetChargeAccount","param":{"appid":"mlive"}}}';

//   const ieResult = ie(data);
//   const aeResult = await ae(data);
...
console.log(ie(form))
ae(form).then(res => {console.log(res)})
